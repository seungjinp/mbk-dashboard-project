function init() {
    ...
    const headMotion = () => {
        pos.y > wrapper.clientHeight - 100 ? (head.style.top = "-15px") : (head.style.top = "-30px")
    }
    ...
    const decideStop = () => {
        if ((cat.classList.contains("face_right") && pos.x - 90 === cat.offsetLeft) || (cat.classList.contains("face_left") && pos.x + 10 === cat.offsetLeft)) {
